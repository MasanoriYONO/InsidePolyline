...
$.mobile.fixedToolbars = (function() {
	...
	return {
		...
		toggle: function( from ) {
			...
			//yono modiy 2011/12/09 09:01
			return ( currentstate === "overlay" ) ? $.mobile.fixedToolbars.hide() : $.mobile.fixedToolbars.show();
			//return $.mobile.fixedToolbars.show();
		},

		setTouchToggleEnabled: function( enabled ) {
			touchToggleEnabled = enabled;
			//console.log("setTouchToggleEnabled:" + touchToggleEnabled);
		}
	};
})();
